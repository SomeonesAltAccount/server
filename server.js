...
// Simple visual biome regions layered onto the grid map. Each is just a
// rectangle or circle with a type name - the client decides how to color
// and layer them. Sent to every client once on join.
const BIOMES = [
    { type: 'ocean', shape: 'rect', x: 0, y: 0, w: WORLD_W, h: WORLD_H },
    { type: 'beach', shape: 'rect', x: 350, y: 350, w: WORLD_W - 700, h: WORLD_H - 700 },
    { type: 'land', shape: 'rect', x: 400, y: 400, w: WORLD_W - 800, h: WORLD_H - 800 },
    { type: 'river', shape: 'rect', x: WORLD_W / 2 - 60, y: 400, w: 120, h: WORLD_H / 2 - 400 },
    { type: 'volcano', shape: 'circle', cx: WORLD_W / 2, cy: WORLD_H / 2, r: 180 }
];
    ...
    socket.on('message', (message) => {
        ...
        if (data.type === 'join') {
            ...
            socket.send(JSON.stringify({
                type: 'init',
                id: playerId,
                world: { width: WORLD_W, height: WORLD_H, biomes: BIOMES },
